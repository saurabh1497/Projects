...
//		Author a1 = new Author("saurabh", "sharma", "Mumbai", LocalDate.of(1999, 2, 21), 23);
//		Author a2 = new Author("sameer", "dev", "Pune", LocalDate.of(1999, 2, 21), 20);
//		Author a3 = new Author("rahul", "singh", "Mumbai", LocalDate.of(1999, 2, 21), 21);
//		
...
//		}
		...
		TypedQuery<Author> query = em.createNamedQuery("updateById", Author.class);
		//query.setParameter("city",  "Mumbai");
